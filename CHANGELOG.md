...
### Added
- Archetype-specific skills: `aget-handle-incident`, `aget-run-playbook`
- Formal ontology: `ontology/ONTOLOGY_operator.yaml` (7 concepts, 2 clusters)
...
- README structure: "Why Operator?" value proposition
